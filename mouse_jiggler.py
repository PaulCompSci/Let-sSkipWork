...
class MouseJiggler:
    ...
    def setup_ui(self):
        ...
        # Safe mode
        ttk.Checkbutton(main_frame, text="Safe Mode", 
                       variable=self.safe_mode).grid(row=0, column=0, columnspan=2, pady=10)
        ...
        self.start_button = ttk.Button(button_frame, text="Start", command=self.start_jiggling)
        ...
        info_label = ttk.Label(main_frame, text="Press Escape or Ctrl+Q to stop", font=("Arial", 9))
    ...
    def setup_keyboard_bindings(self):
        ...
        self.root.bind('<Escape>', lambda event: self.stop_jiggling())
        self.root.bind('<Control-q>', lambda event: self.stop_jiggling())
